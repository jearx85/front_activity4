<template>
    <div class="container">
            <form>
                ...
                <button type="submit" class="btn btn_update" @click="updateProgram">Actualizar</button>
    ...
    export default {
        ...
        data(){
            ...
            async created(){
                ...
                const response = await fetch("http://127.0.0.1:8000/api/program/" + this.$route.params.id+ "/edit", options);
            ...
            methods:{
               async updateProgram(e){
                ...
                const response = await fetch("http://127.0.0.1:8000/api/program/" + this.$route.params.id+ "/update",options);
                const dataProgram = await response.json();
                //console.log(dataProgram);

                this.programs = dataProgram;
